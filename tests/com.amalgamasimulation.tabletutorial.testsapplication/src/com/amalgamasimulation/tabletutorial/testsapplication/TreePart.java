...
import com.amalgamasimulation.tabletutorial.tests.utils.AbstractVisualizedTest;
...
public class TreePart {
	...
	private void runTest(SingleTestTreeElement test) {
		...
		messageManager.send(PlatformTopics.SHOW_MODEL, null);
		test.runTest();
		treeView.updateView();
	}
	...
	private void runWithAnimation(SingleTestTreeElement test) {
		...
		messageManager.send(PlatformTopics.SHOW_MODEL, test.getModel());
