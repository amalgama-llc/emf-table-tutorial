...
public class Model extends com.amalgamasimulation.engine.Model {
	...
	private void dispatchAgent(Agent agent) {
		List<Node> possibleDestinationNodes = graphEnvironment	.getNodeValues()
																...
																.filter(n -> graphEnvironment.getShortestPath(agent.getCurrentNode().getValue(), n) != null)
																.toList();
	...
	private Polyline createPolyline(com.amalgamasimulation.tabletutorial.datamodel.Arc dmArc) {
