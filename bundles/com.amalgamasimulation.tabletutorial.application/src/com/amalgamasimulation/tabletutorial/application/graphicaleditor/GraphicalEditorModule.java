package com.amalgamasimulation.tabletutorial.application.graphicaleditor;
...
import com.amalgamasimulation.tabletutorial.application.graphicaleditor.handlers.CreateArcHandler;
import com.amalgamasimulation.tabletutorial.application.graphicaleditor.handlers.CreateObjectHandler;
...
public class GraphicalEditorModule extends com.amalgamasimulation.graphicaleditor.Module {
	...
	protected Class<? extends ContentPartFactory> getContentPartFactoryType() {
		return com.amalgamasimulation.tabletutorial.application.graphicaleditor.factories.ContentPartFactory.class;
	}
