package com.amalgamasimulation.tabletutorial.application.utils.validation;
...
public final class ValidationManager {
	...
	public void validate(MessageManager messageManager, Scenario scenario, EPartService partService) {
		if (scenario != null) {
			...
			messageManager.send(PlatformTopics.PROBLEMS_PART, this);
		}
	}
	
	private void activateProblemPart(EPartService partService) {
		MPart part = partService.findPart("com.amalgamasimulation.tabletutorial.application.part.properties");
