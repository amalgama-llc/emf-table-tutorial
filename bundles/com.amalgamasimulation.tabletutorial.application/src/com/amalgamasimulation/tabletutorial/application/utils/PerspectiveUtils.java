package com.amalgamasimulation.tabletutorial.application.utils;
...
public class PerspectiveUtils {
	 ...
	 */
	public static final String COMMAND_PARAMETER_NAME = "com.amalgamasimulation.tabletutorial.application.commandparameter.switchPerspective";
	
	public static final String MODE_MENU_ID = "com.amalgamasimulation.tabletutorial.application.menu.mode";
	
	private static final String PERSPECTIVE_STACK_ID = "com.amalgamasimulation.tabletutorial.application.perspectivestack.0";
	...
	public enum Perspective {
		EDITOR("com.amalgamasimulation.tabletutorial.application.perspective.editor", false, false),
		SIMULATION("com.amalgamasimulation.tabletutorial.application.perspective.simulation", true, true)
		;
