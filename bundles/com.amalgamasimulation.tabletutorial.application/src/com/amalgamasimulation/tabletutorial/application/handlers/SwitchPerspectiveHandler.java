...
import com.amalgamasimulation.tabletutorial.application.utils.validation.ValidationManager;
...
import com.amalgamasimulation.tabletutorial.application.utils.PerspectiveUtils.Perspective;
...
public class SwitchPerspectiveHandler {
	...
	public static void trySwitchToPerspective(	PerspectiveUtils.Perspective newPerspective, 
		...
		if (newPerspective != appState.getCurrentPerspective()) {
			...
			messageManager.send(PlatformTopics.PERSPECTIVE_CHANGED, null);
			if (newPerspective == PerspectiveUtils.Perspective.SIMULATION) {
				...
				messageManager.post(PlatformTopics.SHOW_MODEL, experimentRun.getModel());
